...
//	ResourceBundle strings = ResourceBundle.getBundle("strings_fr", currentLocale);
	...
	private void defineIDPanel() {
		...
		labelID = new JLabel(strings.getString("id"));
	...
	private void defineFirstNamePanel() {
		...
		labelFirstName = new JLabel(strings.getString("firstname"));
	...
	private void defineLastNamePanel() {
		...
		labelLastName = new JLabel(strings.getString("lastname"));
	...
	private void defineSSNPanel() {
		...
		labelSSN = new JLabel(strings.getString("ssn"));
	...
	private void defineStreetPanel() {
		...
		labelStreet = new JLabel(strings.getString("street"));
	...
	private void defineCityPanel() {
		...
		labelCity = new JLabel(strings.getString("city"));
	...
	private void defineStatePanel() {
		...
		labelState = new JLabel(strings.getString("state"));
	...
	private void defineZipPanel() {
		...
		labelZip = new JLabel(strings.getString("zip"));
...
//		labelResult.setBorder(blueline);
	...
	private void addComboBox() {
		class ChooseLanguageListener implements ItemListener {
...
//		        		ResourceBundle strings = ResourceBundle.getBundle("strings_zh", currentLocale);
	...
	private void addButtonSearch() {
		...
		searchButton = new JButton(strings.getString("search"));
	...
	private void addButtonSave() {
		...
		saveButton = new JButton(strings.getString("save"));
	...
	private void addButtonClear() {
		...
		clearButton = new JButton(strings.getString("clear"));
